...
class Sliding_Window:
    ...
    def draw_lines(image, warped_img, left_fitx, right_fitx, ploty, M_t, exist=True):
        '''
        This function unwarps the lines and draws them to the image. 
        '''
        
        #Make wraper to draw lines on
        warp_zeros = np.zeros_like(warped_img).astype(np.uint8)
    ...
    def visual_lines(binary_warped, left_fit, right_fit, left_lane_inds, right_lane_inds, out_img, nonzeroy, nonzerox):
